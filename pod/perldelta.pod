...
some subtleties when matched in regular expressions against non-Unicode
code points.  There is a warning generated to draw your attention to
this.  However, this warning was being generated under some
circumstances when such code points were used in non-regular expression
parts of Perl, or with non-Unicode properties inside regular
expressions.  These are now fixed.
